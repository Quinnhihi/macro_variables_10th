...
Note: input data for the models is not pushed to git. Input data when updates are required, the latest versions of input data should be downloaded directly from their public sourcesfor (or from internal directories (Teams)) that you will need to save in the relevant location in the `data_source/` directory on your cloned repository. Intermediate datasets generated by scripts and notebooks are stored in the `data/` directory.
